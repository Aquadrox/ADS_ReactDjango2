...
echo "Installation de poetry via pipx..."
# --- CORRECTION ---
# Utilise --force pour garantir que le lien symbolique dans .local/bin est
# recréé, même si pipx pense que poetry est "déjà installé".
...
# On garde le chemin complet, c'est plus robuste
